...
import { reviewProposalAction } from '@/app/_actions/proposals';
...
export function ProposalReviewActions({ proposalId, locale }: ProposalReviewActionsProps) {
